...
public class SQLConstants {
    ...
    public static final String CHECK_SEATS_AVAILABLE_FOR_GIVEN_GYM_AND_SLOT = "select availableSeats from SlotCatalog where gymID = (?) and slotNumber = (?) and availableSeats > 0";
